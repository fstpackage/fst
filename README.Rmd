...
speeds <- speeds[Package == "feather", Methods := "read_feather/write_feather"]
speeds <- speeds[Package == "fst", Methods := "read.fst/write.fst"]
speeds <- speeds[Package == "csv", Methods := "fread/fwrite"]
speeds <- speeds[Package == "rds", Methods := "readRDS/saveRDS"]
speeds <- speeds[Package == "csv", Package := "data.table"]
...
ggplot(speeds[Compression == 0]) +
  ...
  geom_jitter(aes(Mode, Speed, colour = Mode), size = 1, alpha = 0.05, width = 0.25) +
